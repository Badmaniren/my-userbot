...
...(старые уроки обрезаны)...
 ошибки через `except Exception: pass`! Обработай ошибку предсказуемо или пробрось наружу через raise.; тесты перегенерировались после стагнации, но задачу это не спасло
