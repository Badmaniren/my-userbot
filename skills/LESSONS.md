...
орных попыток. Судя по тому, что редирект на архив логов проходит успешно, а не отдаётся именно тело — это похоже на задержку публикации логов у GitHub, а не на нехватку прав токена. Ручного вмешательства это не требует: этот раунд пр
