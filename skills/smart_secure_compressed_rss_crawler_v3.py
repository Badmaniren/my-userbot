...
from skills.memory_profiler import MemoryProfiler, assert_memory_limit
from skills.smart_secure_compressed_rss_crawler import smart_secure_compressed_rss_crawler_flow
...
def smart_secure_compressed_rss_crawler_v3_flow(
    ...
    try:
        result = smart_secure_compressed_rss_crawler_flow(
            url=url,
            timeout=timeout,
            db_path=db_path,
