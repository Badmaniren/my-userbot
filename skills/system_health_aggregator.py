...
class SystemHealthAggregator:
    ...
    def generate_full_report(self, module_name: str, error_msg: str, incident_id: str, audit_data: dict) -> str:
        return self.report_exporter.generate_comprehensive_report(
            module_name, 
            error_msg, 
    ...
    def execute_recovery_sequence(self, incident_id: str, patch_payload: dict, mock_arg) -> bool:
        return self.patch_scheduler.coordinate_and_schedule(incident_id, patch_payload, mock_arg)