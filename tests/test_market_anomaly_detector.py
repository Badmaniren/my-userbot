...
class TestMarketAnomalyDetector(unittest.TestCase):
    ...
    def test_anomaly_detection_logic_and_dispatching(self):
        ...
        self.detector.analyze_market_data = MagicMock(side_effect=side_effect_analyze)
    ...
    def test_stream_processing_with_random_garbage(self):
        ...
        with patch('requests.get') as mock_get:
            ...
            self.detector.process_raw_stream = MagicMock(side_effect=side_effect_process_stream)
    ...
    def test_insider_activity_filter_routing(self):
        ...
        random_score = random.uniform(0.9, 1.0)
        ...
        self.detector.evaluate_insider_risk = MagicMock(side_effect=side_effect_route)
    ...
    def test_database_persistence_on_anomaly(self):
        """Проверка сохранения результатов анализа в БД."""
        ...
        self.detector.persist_anomaly = MagicMock(side_effect=side_effect_persist)
    ...
    def test_parser_error_handling(self):
        """Проверка устойчивости к ошибкам парсера."""
        ...
        self.detector.analyze_market_data = MagicMock(side_effect=side_effect_safe_analyze)
